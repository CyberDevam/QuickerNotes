...
const ProfilePage = ({ mode = 'light' }) => {
  ...
  return (
    <div className={`max-h-[94.6vh] h-[94.6vh] ${mode === 'dark' ? 'bg-gray-900' : 'bg-gray-50'} p-4`}>
      ...
      <div style={{ marginTop: "30px" }} className={`max-w-md mx-auto my-auto p-6 rounded-lg shadow-md ${mode === 'dark' ? 'bg-gray-800' : 'bg-white'} ${mode === 'dark' ? 'text-gray-100' : 'text-gray-800'}`}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            <div className="mb-3">
              <label className={`block mb-1 ${mode === 'dark' ? 'text-gray-300' : 'text-gray-700'}`} htmlFor="currentPassword">
                Current Password
              </label>
              <input
                type="password"
            ...
            <div className="mb-3">
              <label className={`block mb-1 ${mode === 'dark' ? 'text-gray-300' : 'text-gray-700'}`} htmlFor="newPassword">
                New Password
              </label>
              <input
                type="password"
          ...
          <button
            type="submit"
            className={`w-full py-2 px-4 ${mode === 'dark' ? 'bg-blue-600 hover:bg-blue-700' : 'bg-blue-500 hover:bg-blue-600'
