...
const CreateNote = ({ mode }) => {
  ...
  useEffect(() => {
    if (localStorage.getItem("currentNoteTitle") || localStorage.getItem("currentNoteContent") || localStorage.getItem("currentNoteCategory")) {
      setTitle(localStorage.getItem("currentNoteTitle"));
      setContent(localStorage.getItem("currentNoteContent"));
      setCategory(localStorage.getItem("currentNoteCategory"));
    }
  }, []);
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        localStorage.removeItem("currentNoteContent");
        localStorage.removeItem("currentNoteCategory");
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => {
                ...
                localStorage.setItem("currentNoteTitle", e.target.value);
              }}
              required
          ...
          <div>
            ...
            <select
              ...
              onChange={e => {
                ...
                localStorage.setItem("currentNoteCategory", e.target.value);
              }}
              className={`w-full rounded-md px-4 py-2 focus:outline-none focus:ring-2 ${mode === "dark"
          ...
          <div className="relative">
            ...
            <textarea
              ...
              onChange={(e) => {
                ...
                localStorage.setItem("currentNoteContent", e.target.value);
              }}
